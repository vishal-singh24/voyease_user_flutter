...
class EnterMobileNoOtpScreen extends GetView<MobileNoOtpScreenController> {
  const EnterMobileNoOtpScreen({super.key});
  ...
  Widget build(BuildContext context) {
   final Map<String, String> args =
    ...
    return GetBuilder<MobileNoOtpScreenController>(
        init:MobileNoOtpScreenController(),
        initState: (_) {},
        builder: (_) {
          return Scaffold(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 30),
                       Text(
                        "We sent a 6 digit code to your mobile number.: $phoneNo "
                      ...
                      Container(
                        ...
                        child: PrimaryButton(
                          onClick: () {
                           controller.verify(context,verificationid,controller.otpController.text.toString());
                          },
                          label: "Verify",
                        ),
                      ),
